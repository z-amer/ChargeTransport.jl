...
function get_DOS(icc::QType, ireg::Integer, ctsys)
...
function get_BEE(icc::QType, ireg::Integer, ctsys)
...
"""
function etaFunction(sol, ireg::Integer, ctsys, icc::QType)
...
"""
function get_density(sol, ireg::Integer, ctsys, icc::QType)
...
"""
function get_density(sol, data, icc, ireg::Integer, inode)
